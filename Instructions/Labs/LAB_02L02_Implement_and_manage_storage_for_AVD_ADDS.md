...
You need to implement and manage storage for a Azure Virtual Desktop deployment in an Microsoft Entra Directory Domain Services (Microsoft Entra DS) environment.
