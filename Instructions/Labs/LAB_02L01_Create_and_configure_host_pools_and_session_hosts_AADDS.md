...
- Configure an Azure Virtual Desktop environment in an Microsoft Entra DS domain. 
- Validate Azure Virtual Desktop environment in an Microsoft Entra DS domain. 
